...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._loop_range = Range(0, 1000, 1, 6, 200)
        self._loop_win = RangeWidget(self._loop_range, self.set_loop, 'loop', "counter_slider", float)
        self.top_grid_layout.addWidget(self._loop_win)
        ...
        self.qtgui_const_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_AUTO, qtgui.TRIG_SLOPE_POS, 0.3, 0, "")
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(loop*1e-3, 4, False)
        self.digital_clock_recovery_mm_xx_0 = digital.clock_recovery_mm_cc(1e-6*samp_rate, 25e-6, 0.5, 10e-3, 0.005)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/lavarenne/zigbee_24M.bin', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.digital_clock_recovery_mm_xx_0.set_omega(1e-6*self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 1e6, 0.6, 361))
    ...
    def set_loop(self, loop):
        self.loop = loop
        self.digital_costas_loop_cc_0.set_loop_bandwidth(self.loop*1e-3)
