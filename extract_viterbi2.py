...
def extraction(fichier):  #fichier = viterbi2.bin (binarymeteor2.s ligne 25!!) modifié ou viterbi.bin (binarymeteor.s)
	...
	if 64<=chunk_dec[10,0]<=70:
		index=chunk_dec[10][8]*256+chunk_dec[10][9]+12-1
		try:
			#if chunk_dec[i,index]==64 or chunk_dec[i,index]==65 or chunk_dec[i,index]==68:
			pointeur.append(chunk_dec[10][8]*256+chunk_dec[10][9]+12)
			#print("ongueur:",len(chunk_dec[10+14,index+13:]))
			#print(chunk_dec[10,index+13:])
			telemetry=chunk_dec[10,index+13:]
			print(telemetry[35:50])
